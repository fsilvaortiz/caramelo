Acabo de publicar Caramelo — una extensión open source para VS Code que trae spec-driven development con una UI visual y soporte para cualquier LLM.

El problema: GitHub Spec Kit es increíble para desarrollo basado en especificaciones, pero funciona solo con slash commands. Kiro ofrece una experiencia visual, pero te ata a un solo LLM.
